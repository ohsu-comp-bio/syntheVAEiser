...
def noise_inject_1(latent_object, synth_index_name):
    synth_sub_len = 200
    synth_ndx_strt = 0
...
parser.add_argument('cohort_n_index', type = int) # 0 through 24 from line
...
for validation_split in vs_list:
    ...
    synth_full_frame = noise_inject_1(latent_object, fine_tune_file.index.name)
